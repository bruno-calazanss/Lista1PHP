        ...
        <div class="card-text">
            ...
            for($i=1; $i<=2; $i++) { ?>
                <div class="form-group">
                    <label for="<?= "nome$i" ?>"><?php echo "Nome $i:" ?></label>
                    <input type="text" name="<?= "nome$i" ?>" 
                        class="form-control" id="<?= "nome$i" ?>" required>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" value="M" name="<?= "sexo$i" ?>" 
                        class="form-check-input" id="<?= "sexo$i" ?>" required>
                    <label class="form-check-label" for="<?= "sexo$i" ?>">Masculino</label>
                </div>
                <div class="form-check form-check-inline mb-4">
                    <input type="radio" value="F" name="<?= "sexo$i" ?>" 
                        class="form-check-input" id="<?= "sexo$i" ?>" required>
                    <label class="form-check-label" for="<?= "sexo$i" ?>">Feminino</label>
                </div> <?php 
            } ?>
